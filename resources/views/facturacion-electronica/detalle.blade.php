                ...
                <div class="flex flex-wrap items-center gap-4 justify-between">
                    ...
                    <div class="flex gap-2 flex-wrap">
                        ...
                        @if($factura->esRechazada())
                            <form method="POST" action="{{ fe_route('corregir', $factura) }}">
                                @csrf
                                <button type="submit" class="px-4 py-2 bg-blue-600 text-white text-sm font-semibold rounded-lg hover:bg-blue-500 transition">
                                    Corregir datos
                                </button>
                            </form>
