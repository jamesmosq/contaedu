    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-gradient-to-r from-brand-900 to-brand-700 rounded-xl p-6 mb-6 text-white">
                <h3 class="text-lg font-bold mb-1">{{ $auditMode ? 'Empresa de ' : 'Bienvenido, ' }}{{ $student->student_name }}</h3>
                <p class="text-brand-200 text-sm">{{ $auditMode ? 'Modo auditoría — solo lectura.' : 'Tu empresa virtual está lista. Navega por los módulos para completar el ciclo contable.' }}</p>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                <a href="{{ $r['config'] }}" class="bg-white rounded-xl border border-slate-200 p-5 hover:border-brand-300 hover:shadow-sm transition group">
                ...
                <a href="{{ $r['cuentas'] }}" class="bg-white rounded-xl border border-slate-200 p-5 hover:border-brand-300 hover:shadow-sm transition group">
                    <div class="flex items-center gap-3 mb-2">
                ...
                <a href="{{ $r['terceros'] }}" class="bg-white rounded-xl border border-slate-200 p-5 hover:border-brand-300 hover:shadow-sm transition group">
                    <div class="flex items-center gap-3 mb-2">
                        <div class="w-9 h-9 rounded-lg bg-brand-50 flex items-center justify-center group-hover:bg-brand-100 transition">
                ...
                <a href="{{ $r['productos'] }}" class="bg-white rounded-xl border border-slate-200 p-5 hover:border-brand-300 hover:shadow-sm transition group">
                    <div class="flex items-center gap-3 mb-2">
                        <div class="w-9 h-9 rounded-lg bg-accent-50 flex items-center justify-center group-hover:bg-accent-100 transition">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                <a href="{{ $r['facturas'] }}" class="bg-white rounded-xl border border-slate-200 p-5 hover:border-brand-300 hover:shadow-sm transition group">
                ...
                <a href="{{ $r['compras'] }}" class="bg-white rounded-xl border border-slate-200 p-5 hover:border-brand-300 hover:shadow-sm transition group">
                ...
                <a href="{{ $r['reportes'] }}" class="bg-white rounded-xl border border-slate-200 p-5 hover:border-brand-300 hover:shadow-sm transition group">
