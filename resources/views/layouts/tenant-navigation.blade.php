@php
    ...
    if ($demoMode) {
        ...
        $nav = [
            ...
            ['key' => 'sandbox.ejercicios',   'label' => 'Ejercicios',          'route' => route('sandbox.ejercicios'),       'icon' => 'clipboard-document-list'],
        ...
        @foreach($nav as $item)
            ...
            @php
                $isActive = match($item['key']) {
                    ...
                    'sandbox.ejercicios'   => request()->routeIs('sandbox.ejercicios'),
