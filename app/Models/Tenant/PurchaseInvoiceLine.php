...
class PurchaseInvoiceLine extends Model {
    protected $fillable = ['purchase_invoice_id','product_id','description','qty','unit_cost','tax_rate','line_subtotal','line_tax','line_total','cuenta_gasto_codigo','cuenta_gasto_nombre'];
