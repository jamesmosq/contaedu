...
- `contaedu-arquitectura` — Arquitectura completa de ContaEdu. Activar SIEMPRE al inicio de cualquier tarea antes de tocar código. Cubre multitenancy Central/Tenant, zonas sandbox/real, campo modo, helper modoContable(), servicios contables y estructura de archivos. Activar cuando: se inicia una nueva sesión, se trabaje con rutas /aprendizaje o /empresa, multitenancy, servicios, modelos o cualquier cambio estructural.
